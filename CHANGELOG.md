...
- :framed_picture: **HTML iframe embedding** — Raw `.html` files served via `/raw/` now include `charset=utf-8` in the `Content-Type` header and an `X-Frame-Options: SAMEORIGIN` header, fixing display issues where the HTML content was not rendering in the iframe.
...
[Unreleased]: https://github.com/jberends/servemd/compare/v1.3.0...HEAD
[1.3.0]: https://github.com/jberends/servemd/compare/v1.2.2...v1.3.0
[1.2.2]: https://github.com/jberends/servemd/compare/v1.2.1...v1.2.2
[1.2.1]: https://github.com/jberends/servemd/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/jberends/servemd/compare/v1.1.0...v1.2.0
